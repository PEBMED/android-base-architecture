...
class PullRequestListViewModel(
    ...
    private val _pullRequestListState = MutableLiveData<ViewState<List<PullRequest>, String?>>()

    val pullRequestListState: LiveData<ViewState<List<PullRequest>, String?>>
